...
class weight_window_generator:
    ...
    def __init__(self, geometry, mesh, rel_err, important_cell_id, mgxs_lib = None, max_imp = 1500):
        self.cell_dicc = {}
    ...
    def weight_window_setter(self):
        ...
        for cell in all_cells:
            importancia = round(self.mgxs[cell.id][1],4)

            if importancia == 0:
                cell.lower_weight = 1e4
            else:
                cell.lower_weight = 1/importancia
            cell.const_upp_weight = 5
            cell.const_upp_weight = 2.5
